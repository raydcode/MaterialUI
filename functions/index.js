...
let mailOptions = {from: 'Quart Ciphers IT and Consulting Services LLP'};
  ...
  cors(request, response, () => {
    ...
    if (total) {
      if (category) {
        ...
        mailOptions = {
          ...
          html: `<p style="font-size:16px">From:${name}</p>
            ...
            <p style="font-size:16px">Features:${customFeatures}</p>
      ...
      mailOptions = {
        ...mailOptions,
        to: email,
        subject: 'Thank You !! Your Estimate Received ',
        html: `
                              ...
                              <tr>
                                ...
                                >
                                  <table
                                    ...
                                    cellspacing="0"
                                    cellpadding="0"
                                    style="background:#DA0037; border-radius:10px; box-shadow: 0px 4px 15px 0px rgba(0, 0, 0, 0.32);"
                                  >
                                    <tr>
                                      <td
                                        align="center"
                                    ...
                                    <td align="center" style="padding:40px 10px">
                                      ...
                                      >
                                        ...
                                        <tr>
                                          ...
                                          >
                                            <a
                                              href="mailto:quartciphers@gmail.com"
                                              style="color:#ffffff; text-decoration:none!important"
                                              >quartciphers@gmail.com</a
                                            >
                                          </td>
                                        </tr>
                                      </table>
    ...
    `,
      ...
      mailOptions = {
        ...mailOptions,
        to: email,
        subject: 'Thank You !! Your Message Received ',
        html: `
